  ...
  return (
    <Layout>
      ...
      <div className="bg-primary-light p-4 rounded-md mb-6">
        <p className="mb-2"><strong>Ticket ID:</strong> {ticket._id}</p>
        <p className="mb-2"><strong>Name:</strong> {ticket.name}</p>
        <p className="mb-2"><strong>Email:</strong> {ticket.email}</p>
        ...
        <p className="mb-2"><strong>Status:</strong>{' '}
          ...
          <button
            ...
            className="ml-2 text-sm bg-accent px-2 py-1 rounded-md text-white"
          >
            Update
          </button>
        </p>
        <p className="mb-4"><strong>Message:</strong> {ticket.message}</p>
        {hasPrivate && (
          <div className="mb-4">
